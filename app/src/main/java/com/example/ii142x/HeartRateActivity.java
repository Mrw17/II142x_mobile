...
/**
 * Activity that lets the user read its heart rate.
 * It will ask for the permission if it is not granted
 */
public class HeartRateActivity extends Activity implements SensorEventListener, EasyPermissions.PermissionCallbacks {
    ...
    /**
     * It will start to read heartrate
    ...
    public void onAccuracyChanged(Sensor sensor, int i) {
        this.runOnUiThread(() -> {
            try{
                String msg = "Accuracy Changed on: " + sensor.getType();
